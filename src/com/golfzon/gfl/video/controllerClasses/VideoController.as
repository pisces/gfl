...
/**
 *	일시정지 버튼을 클릭했을 때 송출한다.
 */
[Event(name="pauseClick", type="com.golfzon.gfl.events.VideoContollerEvent")]

/**
 *	재생 버튼을 클릭했을 때 송출한다.
 */
[Event(name="playClick", type="com.golfzon.gfl.events.VideoContollerEvent")]

/**
 *	시크 변경 시 송출한다.
 */
[Event(name="seekChange", type="com.golfzon.gfl.events.VideoContollerEvent")]

/**
 *	멈춤 버튼을 클릭했을 때 송출한다.
 */
[Event(name="stopClick", type="com.golfzon.gfl.events.VideoContollerEvent")]

/**
 *	볼륨 변경 시 송출한다.
 */
[Event(name="volumeChange", type="com.golfzon.gfl.events.VideoContollerEvent")]
 ...
 */
include "../../styles/metadata/VideoControllerStyles.as";
 ...
 *	@Description
 */
public class VideoController extends BorderBasedComponent implements IVideoController
{
	//--------------------------------------------------------------------------
	//
	//	Instance constants
	...
	[Embed(source="/assets/GZSkin.swf", symbol="VideoControllerBorderSkin")]
	...
	public function VideoController() {
		...
		defaultBorderClass = BORDER_SKIN;
	}
	...
	override protected function measure():void {
		...
		measureWidth = (isNaN(unscaledWidth) && border) ? border.width : unscaledWidth;
		measureHeight = (isNaN(unscaledHeight) && border) ? border.height : unscaledHeight;
