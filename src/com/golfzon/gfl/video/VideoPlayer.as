...
/**
 *  컨트롤러의 스킨
 * 	@default com.golfzon.gfl.video.controllerClasses.VideoController
 */
[Style(name="videoControllerStyleName", type="String", inherit="no")]
...
public class VideoPlayer extends ComponentBase
{
	...
	override public function styleChanged(styleProp:String):void {
		...
		switch( styleProp ) {
			case StyleProp.VIDEO_CONTROLLER_STYLE_NAME:
				ComponentBase(_controller).styleName = getStyle(StyleProp.VIDEO_CONTROLLER_STYLE_NAME);
				break;
		}
	}
	...
	private function createBg():DisplayObject {
		var bgClass:Class = replaceNullorUndefined(getStyle(StyleProp.BORDER_SKIN), Border);
		if( bgClass ) {
