...
public class RadioButtonGroup extends EventDispatcher
{
    ...
    public function addButton(client:RadioButton):Boolean {
		...
		if( result ) {
			...
			client.addEventListener(MouseEvent.CLICK, buttonClickHandler, false, 0, true);
		...
		if( _selectedIndex != -1 && radioButtons.length > _selectedIndex ) {
			...
			radioButtons[_selectedIndex].dispatchEvent(new MouseEvent(MouseEvent.CLICK));
		}
    ...
    public function removeButton(client:RadioButton):void {
		...
		client.removeEventListener(MouseEvent.CLICK, buttonClickHandler);
