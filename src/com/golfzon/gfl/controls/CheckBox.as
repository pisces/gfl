 ...
 *	@default value symbol "CheckBox_selectedUpSkin" of GZSkin.swf
 */
[Style(name="selectedUpSkin", type="Class", inherit="no")]

/**
 *	선택된 상태의 페이즈가 OVER 상태일 때의 스킨 스타일<br>
 *	@default value symbol "CheckBox_selectedOverSkin" of GZSkin.swf
 */
[Style(name="selectedOverSkin", type="Class", inherit="no")]

/**
 *	선택된 상태의 페이즈가 DOWN 상태일 때의 스킨 스타일<br>
 *	@default value symbol "CheckBox_selectedDownSkin" of GZSkin.swf
 */
...
public class CheckBox extends ComponentBase
{
	...
	[Embed(source="/assets/GZSkin.swf", symbol="CheckBox_selectedDownSkin")]
	private var BUTTON_SELECTED_DOWN_SKIN:Class;
	
	[Embed(source="/assets/GZSkin.swf", symbol="CheckBox_selectedOverSkin")]
	private var BUTTON_SELECTED_OVER_SKIN:Class;
	
	[Embed(source="/assets/GZSkin.swf", symbol="CheckBox_selectedUpSkin")]
