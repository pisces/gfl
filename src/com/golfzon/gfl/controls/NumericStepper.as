...
public class NumericStepper extends BorderBasedComponent
{
	...
	override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void {
		...
		border.width = nextButtonInstance.currentSkin ? unscaledWidth - nextButtonInstance.currentSkin.width + 1 : unscaledWidth;
		border.height = unscaledHeight;
		
		nextButtonInstance.height = (unscaledHeight + 1) / 2;
		nextButtonInstance.x = border.width - 1;
		
		prevButtonInstance.height = (unscaledHeight + 1) / 2;
		prevButtonInstance.x = border.width - 1;
		prevButtonInstance.y = nextButtonInstance.height - 1;
		
		labelInstance.width = border.width;
		labelInstance.height = border.height;
