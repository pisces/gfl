 ...
 */
[Style(name="radiobuttonSelectSkin", type="class", inherit="no")]

/**
 *  업 스킨
 * 	@default value symbol "RadioButton_upSkin" of GZSkin.swf
 */
[Style(name="upArrowUpradiobuttonUpSkinSkin", type="class", inherit="no")]
...
public class RadioButton extends ComponentBase
{
    ...
    private var RADIOBUTTON_SELECT_SKIN:Class;
	...
	private function mouseUpHandler(event:MouseEvent):void {
		if( event.target is UITextField && !_selected ) {
			selected = !_selected;
		}
	...
	private function buttonInstance_changeHandler(event:Event):void {
		_selected = buttonInstance.selected;
