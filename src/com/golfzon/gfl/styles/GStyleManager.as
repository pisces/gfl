...
public class GStyleManager
{
	...
	private static var globalStyleTable:Hashtable = new Hashtable();
	private static var localStyleTable:Hashtable = new Hashtable();
	 ...
	 *	2. 컴퍼넌트 글로벌 정의
	 */
    private static function getCurrnetStyleDeclartion(client:IStyleClient):CSSStyleDeclaration {
