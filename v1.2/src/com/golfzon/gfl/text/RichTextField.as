...
import com.golfzon.gfl.command.CommandManager;
 ...
 */
public class RichTextField extends TextField implements IReceiver
{
	//--------------------------------------------------------------------------
	//
	//	Class variables
	...
	private function initialize():void {
		...
		focusRect = false;
		alwaysShowSelection = tabEnabled = useRichTextClipboard = true;
	...
	public function get commandPackageRoute():String {
		return null;
	}
	
	public function set commandPackageRoute(value:String):void {
	}
	...
	private var _useTab:Boolean;
	
	public function get useTab():Boolean {
		return _useTab;
	}
	
	public function set useTab(value:Boolean):void {
		if( value == _useTab )
			return;
