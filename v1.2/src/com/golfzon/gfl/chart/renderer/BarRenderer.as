...
public class BarRenderer extends RendererBase
{
	...
	private function rendererLabel():Bitmap {
		...
		var tw:Number = sprite.width == 0 ? 10 : sprite.width;
		var th:Number = sprite.height == 0 ? 10 : sprite.height;
		
		var bitmapData1:BitmapData = new BitmapData(tw, th, true, 0xFFFFFF);
		bitmapData1.draw(label);
		bitmapData1.copyPixels(bitmapData1, new Rectangle(2, 2, tw - 2, th - 2), new Point(0, 0));
		
		var bitmapData2:BitmapData = new BitmapData(tw - 4, th - 4, true, 0xFFFFFF);
